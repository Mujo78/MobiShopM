    ...
    return(
        <>
          <CustomCard style={{ width: '8rem', borderRadius: 0}} className="ms-4 mb-3">
            <Card.Img variant="top" src={props.mob.photo} alt="photo" style={{ height:"150px" }} />
            <Card.Body className='d-flex flex-column'>
              ...
              <Button style={{backgroundColor: "#219aeb", border: "none", borderRadius: 0}} className='w-100' onClick={handleShow}>
                See more
              </Button>
              </div>
            </Card.Body>
