...
export default function Info() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .put(
        `http://localhost:3001/edit-profile/${infoPersonState.id}`,
        infoPersonState,
        {
          headers: {
        ...
        <Form className="mb-5" onSubmit={handleSubmit}>
          ...
          >
            <CustomDiv className={isMobile ? "w-100" : "w-50"}>
              ...
              />
              {num > 0 && (
                <ErrorFinder err={errorState} fieldName="first_name" />
              )}
            </CustomDiv>
            <CustomDiv className={isMobile ? "w-100" : "w-50 ms-2"}>
              ...
              />
              {num > 0 && (
                <ErrorFinder err={errorState} fieldName="last_name" />
              )}
            </CustomDiv>
          </FormGroup>
          <Form.Group
          ...
          >
            ...
            <CustomDiv className={isMobile ? "w-100 mb-2" : "w-50 mb-2"}>
              ...
              />
              {num > 0 && (
                <ErrorFinder err={errorState} fieldName="phone_number" />
              )}
            </CustomDiv>
          </Form.Group>
          ...
          <Button
            ...
            className={isDesktop ? "w-25" : "w-100"}
          >
            Save changes
          </Button>
        </Form>
