...
import Accordions from "../components/Mobile/AccordionSearch";
  ...
  return (
    <>
      <Container className="d-flex p-0 m-0">
        ...
        <Container className="d-flex flex-column w-75">
            ...
            {(searchResult ?? []).length > 0 ? (
              (info ?? []).length > 0 ? (
                <Container className="d-flex flex-column">
                  ...
                  <Container className="d-flex flex-wrap p-0 justify-content-center align-items-center">
                    {mobitels}
                  </Container>
                </Container>
              ) : (
              ...
              <Container className="d-flex flex-wrap justify-content-start align-items-center">
                {" "}
                {mobitels}{" "}
              </Container>
            )}
          ...
          {mobiles.length > 0 ? (
            ...
            <Alert className={`${isDesktop ? `w-75` : `w-100`} text-center`}>
      ...
      <Offcanvas show={stateFilter} onHide={handleCloseFilter} placement="end">
        <Offcanvas.Header closeButton>Search filters</Offcanvas.Header>
        <Offcanvas.Body>
          <Accordions
            setBrands={setBrands}
            brands={brands}
