...
exports.createMobitelValidator = [
    check("mobile_name")
        .notEmpty()
        .withMessage(POST_MOBILENAME_MOBILE)
        .bail(),
    check("ram")
        .notEmpty()
    ...
    check("processor")
        .notEmpty()
        .withMessage(POST_PROCESSOR_MOBILE)
        .bail(),
    check("screen_size")
        .notEmpty()
    ...
    check("photo")
        .notEmpty()
        .withMessage(POST_PHOTO_MOBILE)
        .bail(),
    check("os")
        .notEmpty()
        .withMessage(POST_OS_MOBILE)
        .bail(),
    check("camera")
        .notEmpty()
        .withMessage(POST_CAMERA_MOBILE)
        .bail(),
    check("quantity")
        .notEmpty()
        .withMessage(POST_QUANTITY_MOBILE)
        .bail(),
    check("price")
        .notEmpty()
